      ...
      <section id="about" className="py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 max-w-3xl mx-auto text-lg leading-relaxed mb-8">
            The Meesho GST Generator was created to solve a singular problem:
            the tedious, error-prone process of manually aggregating TCS Sales
            and Returns data to file GSTR-1. By automating the aggregation of
            B2C sales and HSN summaries, we save sellers and CAs countless hours
            every month.
          </p>
        </div>
      </section>
